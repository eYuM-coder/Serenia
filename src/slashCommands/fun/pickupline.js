...
const line = [
  ...
  "Do you have a Death Note? Because every time you smile, I feel like I'm having a heart attack!",
  ...
  "If I just had a Goose, I'd command you to be mine!",
...
module.exports = {
  ...
  async execute(interaction) {
    const embed = new MessageEmbed()
      ...
      .setColor(interaction.client.color.pink);
