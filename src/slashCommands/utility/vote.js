const { SlashCommandBuilder, EmbedBuilder } = require("discord.js");const User = require("../../database/schemas/User");
const ms = require("ms");

module.exports = {
  data: new SlashCommandBuilder()
    .setName("vote")
    .setDescription("Serenias vote page"),
          ...
          .setDescription(
            `__**discordbotlist.com**__\n${
              checkDBLVote
                ...
                : "[`Available Now!`](https://discordbotlist.com/bots/Serenia-3175)"
            }\n\n__**Rewards:**__\n`,
          )
          .setAuthor({
