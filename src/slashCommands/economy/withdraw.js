  ...
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option
        .setName("amount")
        .setDescription(
          "The amount to withdraw (number, 'all', 'half', or e.g. '25%', '1k', '2.5m')",
        )
        .setRequired(true),
    )
    .setContexts([0, 1, 2])
      ...
      return interaction.reply({
        embeds: [
          new MessageEmbed()
            .setColor(interaction.client.color.red)
            .setDescription(
              `Invalid amount entered! Please enter a valid number, percentage, or keyword like "all" or "half".`,
            ),
        ],
        ephemeral: true,
      });
    ...
    await interaction.reply({
      embeds: [
        new MessageEmbed()
          ...
          .setDescription(
            `Withdrawn $${abbreviateNumber(parsedAmount)} from your bank.`,
          ),
      ],
    });
  },
