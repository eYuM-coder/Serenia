...
const { getProfile, inc } = require("../../utils/economy");
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const bankSpace = profile.hasInfiniteStorage
      ? Infinity
      : profile.bankCapacity - profile.bank;
    ...
    if (depositAmount < parsedAmount && !profile.hasInfiniteStorage) {
      ...
      embed
        ...
        .setDescription(
          `Deposited $${abbreviateNumber(depositAmount)} to your bank.`,
        );
    }
