...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option.setName("title").setDescription("Embed title (optional)"),
    )
    .addStringOption((option) =>
      option
        .setName("description")
    ...
    .addStringOption((option) =>
      option.setName("color").setDescription("Embed color in HEX (optional)"),
    )
    .addStringOption((option) =>
      option.setName("footer").setDescription("Embed footer text (optional)"),
    )
    .addStringOption((option) =>
      option
        .setName("thumbnail")
    ...
    .addStringOption((option) =>
      option.setName("image").setDescription("Embed image URL (optional)"),
    )
  ...
  async execute(interaction) {
    ...
    if (guildDB.isPremium === "false") {
      const existingCommands = await customCommand.find({
