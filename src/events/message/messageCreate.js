    ...
    try {
      ...
      if (message.content.match(mentionRegex)) {
        ...
        const embed = new MessageEmbed()
          ...
          .setDescription(
            `\nIf you like ${this.client.user.username}, Consider [voting](https://top.gg/bot/767705905235099658), or [inviting](${config.invite_link}) it to your server! Thank you for using Serenia, we hope you enjoy it, as we always look forward to improve the bot`
          )
          .setFooter({
          ...
          return message.channel
            .sendCustom(
              ` ${
                ...
                number === 2
                  ? "*You can check our top.gg page at `https://vote.Serenia.eyum.org`*"
                  : ""
              }`
            )
            .then((s) => {
